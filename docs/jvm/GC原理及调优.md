...
![分代收集算法](../assets/img/jvm/分代收集算法.jpg)
...
![YoungGC日志](../assets/img/jvm/YoungGC日志.jpg)
![FullGC日志](../assets/img/jvm/FullGC日志.jpg)
...
![空间分配担保](../assets/img/jvm/空间分配担保.jpg)
...
![ParNew](../assets/img/jvm/ParNew.jpg)

### 老年代垃圾回收
![CMS7个阶段](../assets/img/jvm/CMS7个阶段.jpg)

CMS GC 以获取最小停顿时间为目的，尽可能减少 STW 时间，可以分为 7 个阶段：

#### 阶段 1：初始标记(Initial Mark)
![阶段 1：初始标记.jpg](../assets/img/jvm/阶段1初始标记.jpg)
...
![阶段 2：并发标记.jpg](../assets/img/jvm/阶段2并发标记.jpg)


#### 阶段 3：并发预清理(Concurrent Preclean)

![阶段 3：并发预清理.jpg](../assets/img/jvm/阶段3并发预清理.jpg)
...
![阶段6并发清除.jpg](../assets/img/jvm/阶段6并发清除.jpg)
